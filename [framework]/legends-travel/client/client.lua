...
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('stdenis-buy-ticket', vector3(2663.5056, -1543.155, 45.969764), RSGCore.Shared.Keybinds['ENTER'], 'Buy a Ticket', {
		type = 'server',
		event = 'legends-travel:server:buyticket',
		args = { Config.TicketCost },
	})
	exports['legends-core']:createPrompt('stdenis-guarma', vector3(2663.5056, -1543.155, 45.969764), RSGCore.Shared.Keybinds['J'], 'Travel to Guarma', { -- [J]
		type = 'client',
		event = 'legends-travel:client:guarma_boat',
		args = {},
	})
...
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('guarma-buy-ticket', vector3(1268.6583, -6851.772, 43.318504), RSGCore.Shared.Keybinds['ENTER'], 'Buy a Ticket', {
		type = 'server',
		event = 'legends-travel:server:buyticket',
		args = { Config.TicketCost },
	})
	exports['legends-core']:createPrompt('guarma-stdenis', vector3(1268.6583, -6851.772, 43.318504), RSGCore.Shared.Keybinds['J'], 'Travel to St Denis', {
		type = 'client',
		event = 'legends-travel:client:stdenis_boat',
		args = {},
	})
...
RegisterNetEvent("legends-travel:client:guarma_boat")
AddEventHandler("legends-travel:client:guarma_boat", function()
	local hasItem = RSGCore.Functions.HasItem('boatticket', 1)
	if hasItem then
		TriggerServerEvent('legends-travel:server:removeItem', 'boatticket', 1)
		-- tp bateau
		DoScreenFadeOut(500)
		Wait(1000)
...
RegisterNetEvent("legends-travel:client:stdenis_boat")
AddEventHandler("legends-travel:client:stdenis_boat", function()
	local hasItem = RSGCore.Functions.HasItem('boatticket', 1)
	if hasItem then
		-- tp bateau
