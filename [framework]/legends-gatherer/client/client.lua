...
Citizen.CreateThread(function()
    for trees, v in pairs(Config.TreeLocations) do
        exports['legends-core']:createPrompt(v.treeType, v.coords, RSGCore.Shared.Keybinds['J'], Lang:t('menu.start_choping') .. v.name, {
            type = 'client',
            event = 'legends-gatherer:clent:dowoodcutting',
            args = {},
        })
...
RegisterNetEvent('legends-gatherer:clent:dowoodcutting')
AddEventHandler('legends-gatherer:clent:dowoodcutting', function()
    if cuttingstarted == false then
        ...
        if hasItem then
            ...
            TriggerServerEvent('legends-gatherer:server:giveWoodReward')
