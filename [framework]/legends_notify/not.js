exports('LegendsNotificationLeft', (title, desc, dict, txtr, timer) => {
	...
	if (dict === "generic_textures" && txtr === "tick") {
		struct2.setBigInt64(48, BigInt(GetHashKey("COLOR_GREEN")), true);
	} else if (dict === "menu_textures" && txtr === "cross") {
		struct2.setBigInt64(48, BigInt(GetHashKey("COLOR_RED")), true);
	} else {
...
// exports('LegendsNotificationLeft', (text, dict, icon, text_color, duration) => {
