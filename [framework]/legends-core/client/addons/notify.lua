...
-- Credit: VORP (outsider31000) @ https://github.com/VORPCORE/vorp-core-lua

exports("showFailMissionNotif", function(title, subTitle, duration)
...
exports("updateMissionNotif", function(utitle, umsg, duration)
...
exports("warningNotif", function(title, msg, _audioRef, _audioName, duration)
    local title = CreateVarString(10, "LITERAL_STRING", title)
