...
RegisterNetEvent('RSGCore:Client:UseItem', function(item)
    RSGCore.Debug(string.format("%s triggered RSGCore:Client:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check legends-inventory for the right use on this event.", GetInvokingResource(), GetPlayerServerId(PlayerId())))
    RSGCore.Debug(item)
end)
