...
RegisterServerEvent('RSGCore:DebugSomething', function(tbl, indent)
    local resource = GetInvokingResource() or "legends-core"
...
function RSGCore.Debug(tbl, indent)
    TriggerEvent('RSGCore:DebugSomething', tbl, indent)
end
