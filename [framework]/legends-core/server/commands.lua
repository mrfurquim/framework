...
RSGCore.Commands.Add('job', Lang:t("command.job.help"), {}, false, function(source)
    ...
    TriggerClientEvent('RSGCore:NotifyLeft', source, ''..Lang:t('info.job_info',''..PlayerJob.label, 'menu_textures', 'menu_icon_alert', 3000))
end, 'user')
...
RegisterCommand("feedme", function(meta, data)
...
-- RSGCore.Commands.Add("v4", "copy v4 coords", {}, false,function(source)
...
-- RSGCore.Commands.Add("v3","copy v3coords", {}, false, function(source)
...
-- RSGCore.Commands.Add("v2","copy v2coords", {}, false, function(source)
--     local playerPos = GetEntityCoords(PlayerPedId())
