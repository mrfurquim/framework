...
AddEventHandler('playerDropped', function(reason)
    ...
    TriggerEvent('legends-log:server:CreateLog', 'joinleave', 'Dropped', 'red', '**' .. GetPlayerName(src) .. '** (' .. Player.PlayerData.license .. ') left..' ..'\n **Reason:** ' .. reason)
...
-- Non-Chat Command Calling (ex: legends-adminmenu)
