...
-- sell small fish
RegisterServerEvent('legends-fishvendor:server:sellsmallfish')
AddEventHandler('legends-fishvendor:server:sellsmallfish', function()
    local src = source
...
-- sell medium fish
RegisterServerEvent('legends-fishvendor:server:sellmediumfish')
AddEventHandler('legends-fishvendor:server:sellmediumfish', function()
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
    local price = 0
...
-- sell large fish
RegisterServerEvent('legends-fishvendor:server:selllargefish')
AddEventHandler('legends-fishvendor:server:selllargefish', function()
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
    local price = 0
