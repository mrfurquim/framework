...
CreateThread(function()
    for weaponsmith, v in pairs(Config.WeaponCraftingPoint) do
        exports['legends-core']:createPrompt(v.prompt, v.coords, RSGCore.Shared.Keybinds['J'], Lang:t('menu.open') .. v.name, {
            type = 'client',
            event = 'legends-weaponsmith:client:mainmenu',
            args = { v.job },
        })
...
-- weaponsmith menu
RegisterNetEvent('legends-weaponsmith:client:mainmenu', function(jobaccess)
    if currentjob == jobaccess then
        exports['legends-menu']:openMenu({
            ...
            },
            {
                ...
                icon = "fas fa-tools",
                params = {
                    event = 'legends-weaponsmith:client:partsmenu',
                    isServer = false,
                }
            },
            {
                ...
                icon = "fas fa-tools",
                params = {
                    event = 'legends-weaponsmith:client:weaponmenu',
                    isServer = false,
                }
            },
            {
                ...
                icon = "fas fa-box",
                params = {
                    event = 'legends-weaponsmith:client:storage',
                    isServer = false,
                    args = {},
                }
            },
...
-- parts menu
RegisterNetEvent('legends-weaponsmith:client:partsmenu', function()
    partsMenu = {}
    partsMenu = {
        {
            header = Lang:t('menu.weapon_parts_crafting'),
    ...
    for k, v in pairs(Config.WeaponPartsCrafting) do
        partsMenu[#partsMenu + 1] = {
            ...
            icon = 'fas fa-cog',
            params = {
                event = 'legends-weaponsmith:client:partscheckitems',
                args = {
                    name = v.name,
                    lable = v.lable,
                    item = k,
    ...
    exports['legends-menu']:openMenu(partsMenu)
end)

-- weaponsmith weapon menu
RegisterNetEvent('legends-weaponsmith:client:weaponmenu', function()
    exports['legends-menu']:openMenu({
        {
            header = Lang:t('menu.weapon_crafting'),
            isMenuHeader = true,
        },
        {
            ...
            icon = "fas fa-tools",
            params = {
                event = 'legends-weaponsmith:client:revlovermenu',
                isServer = false,
            }
        },
        {
            ...
            icon = "fas fa-tools",
            params = {
                event = 'legends-weaponsmith:client:pistolmenu',
                isServer = false,
            }
        },
        {
            ...
            icon = "fas fa-tools",
            params = {
                event = 'legends-weaponsmith:client:repeatermenu',
                isServer = false,
            }
        },
        {
            ...
            icon = "fas fa-tools",
            params = {
                event = 'legends-weaponsmith:client:riflemenu',
                isServer = false,
            }
        },
        {
            ...
            icon = "fas fa-tools",
            params = {
                event = 'legends-weaponsmith:client:shotgunmenu',
                isServer = false,
            }
        },
        {
...
-- revlover menu
RegisterNetEvent('legends-weaponsmith:client:revlovermenu', function()
    revloverMenu = {}
    revloverMenu = {
        {
            header = Lang:t('menu.revolver_crafting'),
    ...
    for k, v in pairs(Config.RevloverCrafting) do
        revloverMenu[#revloverMenu + 1] = {
            ...
            icon = 'fas fa-cog',
            params = {
                event = 'legends-weaponsmith:client:checkrevloveritems',
                args = {                
                    name = v.name,
                    lable = v.lable,
                    item = k,
    ...
    exports['legends-menu']:openMenu(revloverMenu)
end)

-- pistol menu
RegisterNetEvent('legends-weaponsmith:client:pistolmenu', function()
    pistolMenu = {}
    pistolMenu = {
        {
            header =Lang:t('menu.pistol_crafting'),
    ...
    for k, v in pairs(Config.PistolCrafting) do
        pistolMenu[#pistolMenu + 1] = {
            ...
            icon = 'fas fa-cog',
            params = {
                event = 'legends-weaponsmith:client:checkpistolitems',
                args = {                
                    name = v.name,
                    lable = v.lable,
                    item = k,
    ...
    exports['legends-menu']:openMenu(pistolMenu)
end)

-- repeater menu
RegisterNetEvent('legends-weaponsmith:client:repeatermenu', function()
    repeaterMenu = {}
    repeaterMenu = {
        {
            header = Lang:t('menu.repeater_crafting'),
    ...
    for k, v in pairs(Config.RepeaterCrafting) do
        repeaterMenu[#repeaterMenu + 1] = {
            ...
            icon = 'fas fa-cog',
            params = {
                event = 'legends-weaponsmith:client:checkrepeateritems',
                args = {                
                    name = v.name,
                    lable = v.lable,
                    item = k,
    ...
    exports['legends-menu']:openMenu(repeaterMenu)
end)

-- rifle menu
RegisterNetEvent('legends-weaponsmith:client:riflemenu', function()
    rifleMenu = {}
    rifleMenu = {
        {
            header = Lang:t('menu.rifle_crafting'),
    ...
    for k, v in pairs(Config.RifleCrafting) do
        rifleMenu[#rifleMenu + 1] = {
            ...
            icon = 'fas fa-cog',
            params = {
                event = 'legends-weaponsmith:client:checkrifleitems',
                args = {                
                    name = v.name,
                    lable = v.lable,
                    item = k,
    ...
    exports['legends-menu']:openMenu(rifleMenu)
end)

-- shotgun menu
RegisterNetEvent('legends-weaponsmith:client:shotgunmenu', function()
    shotgunMenu = {}
    shotgunMenu = {
        {
            header = Lang:t('menu.shotgun_crafting'),
    ...
    for k, v in pairs(Config.ShotgunCrafting) do
        shotgunMenu[#shotgunMenu + 1] = {
            ...
            icon = 'fas fa-cog',
            params = {
                event = 'legends-weaponsmith:client:checkshotgunitems',
                args = {                
                    name = v.name,
                    lable = v.lable,
                    item = k,
    ...
    exports['legends-menu']:openMenu(shotgunMenu)
end)

------------------------------------------------------------------------------------------------------

-- parts crafting : check player has the items
RegisterNetEvent('legends-weaponsmith:client:partscheckitems', function(data)
    RSGCore.Functions.TriggerCallback('legends-weaponsmith:server:checkitems', function(hasRequired)
    if (hasRequired) then
        if Config.Debug == true then
            print("passed")
        end
        TriggerEvent('legends-weaponsmith:client:startpartscrafting', data.name, data.lable, data.item, tonumber(data.crafttime), data.receive)
    else
        if Config.Debug == true then
            print("failed")
        end
...
RegisterNetEvent('legends-weaponsmith:client:checkrevloveritems', function(data)
    RSGCore.Functions.TriggerCallback('legends-weaponsmith:server:checkitems', function(hasRequired)
    if (hasRequired) then
        if Config.Debug == true then
            print("passed")
        end
        TriggerEvent('legends-weaponsmith:client:startrevlovercrafting', data.name, data.lable, data.item, tonumber(data.crafttime), data.receive)
    else
        if Config.Debug == true then
            print("failed")
        end
...
RegisterNetEvent('legends-weaponsmith:client:checkpistolitems', function(data)
    RSGCore.Functions.TriggerCallback('legends-weaponsmith:server:checkitems', function(hasRequired)
    if (hasRequired) then
        if Config.Debug == true then
            print("passed")
        end
        TriggerEvent('legends-weaponsmith:client:startpistolcrafting', data.name, data.lable, data.item, tonumber(data.crafttime), data.receive)
    else
        if Config.Debug == true then
            print("failed")
        end
...
RegisterNetEvent('legends-weaponsmith:client:checkrepeateritems', function(data)
    RSGCore.Functions.TriggerCallback('legends-weaponsmith:server:checkitems', function(hasRequired)
    if (hasRequired) then
        if Config.Debug == true then
            print("passed")
        end
        TriggerEvent('legends-weaponsmith:client:startrepeatercrafting', data.name, data.lable, data.item, tonumber(data.crafttime), data.receive)
    else
        if Config.Debug == true then
            print("failed")
        end
...
RegisterNetEvent('legends-weaponsmith:client:checkrifleitems', function(data)
    RSGCore.Functions.TriggerCallback('legends-weaponsmith:server:checkitems', function(hasRequired)
    if (hasRequired) then
        if Config.Debug == true then
            print("passed")
        end
        TriggerEvent('legends-weaponsmith:client:startriflecrafting', data.name, data.lable, data.item, tonumber(data.crafttime), data.receive)
    else
        if Config.Debug == true then
            print("failed")
        end
...
RegisterNetEvent('legends-weaponsmith:client:checkshotgunitems', function(data)
    RSGCore.Functions.TriggerCallback('legends-weaponsmith:server:checkitems', function(hasRequired)
    if (hasRequired) then
        if Config.Debug == true then
            print("passed")
        end
        TriggerEvent('legends-weaponsmith:client:startshotguncrafting', data.name, data.lable, data.item, tonumber(data.crafttime), data.receive)
    else
        if Config.Debug == true then
            print("failed")
        end
...
RegisterNetEvent('legends-weaponsmith:client:startpartscrafting', function(name, lable, item, crafttime, receive)
    ...
    RSGCore.Functions.Progressbar('craft-parts', Lang:t('progressbar.crafting_a')..lable, crafttime, false, true, {
        ...
        TriggerServerEvent('legends-weaponsmith:server:finishcrafting', craftitems, receive)
    end)
end)

-- start revlover crafting
RegisterNetEvent('legends-weaponsmith:client:startrevlovercrafting', function(name, lable, item, crafttime, receive)
...
RegisterNetEvent('legends-weaponsmith:client:startpistolcrafting', function(name, lable, item, crafttime, receive)
...
RegisterNetEvent('legends-weaponsmith:client:startrepeatercrafting', function(name, lable, item, crafttime, receive)
...
RegisterNetEvent('legends-weaponsmith:client:startriflecrafting', function(name, lable, item, crafttime, receive)
...
RegisterNetEvent('legends-weaponsmith:client:startshotguncrafting', function(name, lable, item, crafttime, receive)
...
RegisterNetEvent('legends-weaponsmith:client:storage', function()
...
RegisterNetEvent('legends-weaponsmith:client:serviceweapon', function(item, amount)
    local playerjob = PlayerData.job.name
    if playerjob == currentjob then
