...
AddEventHandler('RSGCore:Client:OnPlayerLoaded', function() -- Don't use this with the native method
    ...
    TriggerEvent('legends-jobwagon:client:setupjobsystem')
end)
...
-- setup job system
RegisterNetEvent('legends-jobwagon:client:setupjobsystem', function()
...
-- job wagon menu
RegisterNetEvent('legends-jobwagon:client:openWagonMenu', function()
    exports['legends-menu']:openMenu({
        ...
        },
        {
            ...
            icon = "fas fa-box",
            params = {
                event = 'legends-jobwagon:server:SetupWagon',
                isServer = true,
                args = {},
            }
        },
        {
            ...
            icon = "fas fa-box",
            params = {
                event = 'legends-jobwagon:client:SpawnWagon',
                isServer = false,
                args = {},
            }
        },
        {
            ...
            icon = "fas fa-box",
            params = {
                event = 'legends-jobwagon:client:storewagon',
                isServer = false,
                args = {},
            }
        },
...
-- spawn company wagon
RegisterNetEvent('legends-jobwagon:client:SpawnWagon', function()
    RSGCore.Functions.TriggerCallback('legends-jobwagon:server:GetActiveWagon', function(data)
        if data ~= nil then
...
-- store wagon
RegisterNetEvent('legends-jobwagon:client:storewagon', function()
