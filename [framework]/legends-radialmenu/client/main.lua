...
local function setRadialState(bool, sendMessage, delay)
    ...
    if bool then
        TriggerEvent('legends-radialmenu:client:onRadialmenuOpen')
        SetupRadialMenu()
    else
        TriggerEvent('legends-radialmenu:client:onRadialmenuClose')
    end
...
RegisterNetEvent('legends-radialmenu:client:noPlayers', function()
...
RegisterNetEvent('legends-radialmenu:client:SendPoliceEmergencyAlert', function()
    ...
    -- notify medics
    TriggerServerEvent('legends-medic:server:medicAlert', 'Medic '..firstname..' '..lastname..' emergency button pressed!')
end)

-- medic emergency button pressed
RegisterNetEvent('legends-radialmenu:client:SendMedicEmergencyAlert', function()
    local Player = RSGCore.Functions.GetPlayerData()
    local firstname = Player.charinfo.firstname
    local lastname = Player.charinfo.lastname
    -- notify medics
