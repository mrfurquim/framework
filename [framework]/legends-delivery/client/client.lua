...
Citizen.CreateThread(function()
    for delivery, v in pairs(Config.DeliveryLocations) do
        exports['legends-core']:createPrompt(v.deliveryid, v.startcoords, RSGCore.Shared.Keybinds['J'], v.name, {
            type = 'client',
            event = 'legends-delivery:client:vehiclespawn',
...
RegisterNetEvent('legends-delivery:client:vehiclespawn')
AddEventHandler('legends-delivery:client:vehiclespawn', function(deliveryid, cart, cartspawn, cargo, light, endcoords, showgps)
            ...
            if wagonSpawned == true then
                ...
                if #(vehpos - endcoords) < 250.0 then
                    ...
                    if #(vehpos - endcoords) < 3.0 then
                        ...
                        TriggerServerEvent('legends-delivery:server:givereward', cashreward)
                        wagonSpawned = false
                    end
                end
            end
