...
function MenuGarage()
    ...
    vehicleMenu[#vehicleMenu+1] = {
        ...
        txt = "",
        params = {
            event = "legends-menu:client:closeMenu"
        }

    }
    exports['legends-menu']:openMenu(vehicleMenu)
end

function CreatePrompts()
    for k,v in pairs(Config.Locations['duty']) do
        exports['legends-core']:createPrompt('duty_prompt_' .. k, v, RSGCore.Shared.Keybinds['J'], 'Toggle duty status', {
            type = 'client',
            event = 'legends-policejob:ToggleDuty',
            args = {},
        })
    end
    
    for k, v in pairs(Config.Locations["vehicle"]) do
        exports['legends-core']:createPrompt("police:vehicle_"..k, vector3(v.x, v.y, v.z), RSGCore.Shared.Keybinds['R'], 'Jobgarage', {
            type = 'client',
    ...
    for k,v in pairs(Config.Locations['evidence']) do
        exports['legends-core']:createPrompt('evidence_prompt_' .. k, v, RSGCore.Shared.Keybinds['J'], 'Open Evidence Stash', {
            type = 'client',
    ...
    for k,v in pairs(Config.Locations['stash']) do
        exports['legends-core']:createPrompt('stash_prompt_' .. k, v, RSGCore.Shared.Keybinds['J'], 'Open Personal Stash', {
            type = 'client',
    ...
    for k,v in pairs(Config.Locations['armory']) do
        exports['legends-core']:createPrompt('armory_prompt_' .. k, v, RSGCore.Shared.Keybinds['J'], 'Open Armory', {
            type = 'client',
...
RegisterNetEvent('legends-policejob:ToggleDuty', function()
    onDuty = not onDuty
