...
-- sell blood money
RegisterServerEvent('legends-outlawpost:server:sellbloodmoney')
AddEventHandler('legends-outlawpost:server:sellbloodmoney', function(amount)
    local src = source
...
-- sell gold bars
RegisterServerEvent('legends-outlawpost:server:sellgoldbars')
AddEventHandler('legends-outlawpost:server:sellgoldbars', function(amount)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
    local amount = tonumber(amount)
