...
RegisterNetEvent('legends-trapperplus:server:storepelt')
AddEventHandler('legends-trapperplus:server:storepelt', function(rewarditem1, rewarditem2)
    local src = source
...
RegisterServerEvent('legends-trapperplus:server:sellpelts')
AddEventHandler('legends-trapperplus:server:sellpelts', function()
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
    local price = 0
