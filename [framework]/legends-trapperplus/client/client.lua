...
Citizen.CreateThread(function()
    for trapper, v in pairs(Config.TrapperLocations) do
        exports['legends-core']:createPrompt(v.location, v.coords, RSGCore.Shared.Keybinds['J'],  Lang:t('menu.open') .. v.name, {
            type = 'client',
            event = 'legends-trapperplus:client:menu',
            args = {},
        })
...
-- trapper menu
RegisterNetEvent('legends-trapperplus:client:menu', function()
    exports['legends-menu']:openMenu({
        ...
        },
        {
            ...
            icon = "fas fa-paw",
            params = {
                event = 'legends-trapperplus:client:sellpelts',
                isServer = false,
            }
        },
        {
            ...
            params = {
                event = 'legends-trapperplus:client:OpenTrapperShop',
                isServer = false,
                args = {}
            }
        },
...
RegisterNetEvent('legends-trapperplus:client:sellpelts', function()
    RSGCore.Functions.Progressbar('make-product', Lang:t('progressbar.checking_pelts'), Config.SellTime, false, true, {
        ...
        TriggerServerEvent('legends-trapperplus:server:sellpelts')
    end)
end)
            ...
            for i = 1, #Config.Pelts do
                if pelthash == Config.Pelts[i].pelthash then
                    ...
                    if deleted then
                        ...
                        TriggerServerEvent('legends-trapperplus:server:storepelt', rewarditem1, rewarditem2)
                    else
...
-- trapper shop
RegisterNetEvent('legends-trapperplus:client:OpenTrapperShop')
AddEventHandler('legends-trapperplus:client:OpenTrapperShop', function()
    local ShopItems = {}
