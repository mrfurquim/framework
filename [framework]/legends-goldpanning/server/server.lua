...
RSGCore.Functions.CreateUseableItem("goldpan", function(source, item)
    local src = source
    TriggerClientEvent("legends-goldpanning:client:StartGoldPan", src, item.name)
end)

-- give reward
RegisterServerEvent('legends-goldpanning:server:reward')
AddEventHandler('legends-goldpanning:server:reward', function()
    local src = source
    ...
    if foundgold < Config.GoldChance then
        ...
        if chance <= 50 then
            ...
            -- webhook
            TriggerEvent('legends-log:server:CreateLog', 'goldpanning', 'Gold Found 🌟', 'yellow', firstname..' '..lastname..' found a gold nugget!')
        end
        if chance >= 50 and chance <= 80 then -- medium reward
            ...
            -- webhook
            TriggerEvent('legends-log:server:CreateLog', 'goldpanning', 'Gold Fever 🌟', 'yellow', firstname..' '..lastname..' found two gold nuggets!')
        end
        if chance > 80 then -- large reward
            ...
            -- webhook
            TriggerEvent('legends-log:server:CreateLog', 'goldpanning', 'Jackpot Gold Find 🌟', 'yellow', firstname..' '..lastname..' found three gold nuggets!')
        end
    else
...
-- give hotspot reward
RegisterServerEvent('legends-goldpanning:server:hotspotreward')
AddEventHandler('legends-goldpanning:server:hotspotreward', function()
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
    local foundgold = math.random(1,100)
    local firstname = Player.PlayerData.charinfo.firstname
    ...
    if foundgold < Config.HSGoldChance then
        ...
        if chance <= 50 then
            ...
            TriggerClientEvent('RSGCore:Notify', src, Lang:t('primary.not_much_this_pan'), 'primary')
            -- webhook
            TriggerEvent('legends-log:server:CreateLog', 'goldpanning', 'Mega Gold Found 🌟', 'yellow', firstname..' '..lastname..' found a gold nugget!')
        end
        if chance >= 50 and chance <= 80 then -- medium reward
            local item1 = Config.RewardItems[math.random(1, #Config.RewardItems)]
            local item2 = Config.RewardItems[math.random(1, #Config.RewardItems)]
            ...
            TriggerClientEvent('RSGCore:Notify', src, Lang:t('primary.looks_like_good_gold'), 'primary')
            -- webhook
            TriggerEvent('legends-log:server:CreateLog', 'goldpanning', 'Mega Gold Fever 🌟', 'yellow', firstname..' '..lastname..' found two gold nuggets!')
        end
        if chance > 80 then -- large reward
            local item1 = Config.RewardItems[math.random(1, #Config.RewardItems)]
            local item2 = Config.RewardItems[math.random(1, #Config.RewardItems)]
            ...
            TriggerClientEvent('RSGCore:Notify', src, Lang:t('primary.gold_fever_jackpot'), 'primary')
            -- webhook
            TriggerEvent('legends-log:server:CreateLog', 'goldpanning', 'Mega Jackpot Gold Find 🌟', 'yellow', firstname..' '..lastname..' found three gold nuggets!')
        end
    else
        TriggerClientEvent('RSGCore:Notify', src, Lang:t('primary.no_gold_this_time'), 'primary')
    end
