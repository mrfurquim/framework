...
RegisterNetEvent('legends-goldpanning:client:StartGoldPan')
AddEventHandler('legends-goldpanning:client:StartGoldPan', function()
        ...
        if panning == false then
            ...
            if canPan == true then
                ...
                if hotspot == true then
                    TriggerServerEvent('legends-goldpanning:server:hotspotreward')
                else
                    TriggerServerEvent('legends-goldpanning:server:reward')
                end
                panning = false
                canPan = false
            else
