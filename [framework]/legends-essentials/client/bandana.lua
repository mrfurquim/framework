...
RegisterNetEvent('legends-bandana:client:ToggleBandana')
AddEventHandler('legends-bandana:client:ToggleBandana', function()
    local ped = PlayerPedId()
    local male = IsPedMale(ped)
    local neckwear = exports['legends-clothes']:GetClothesCurrentComponentHash('neckwear')

    -- Beard of Power: https://www.nexusmods.com/skyrimspecialedition/mods/42635
     --local beard = exports['legends-appearance']:GetBodyCurrentComponentHash('beard')
    ...
    Citizen.InvokeNative(0xD3A7B003ED343FD9, ped, beard, true, true, true)
    Citizen.InvokeNative(0xCC8CA3E88256E58F, ped, 0, 1, 1, 1, false)
