...
RegisterNetEvent('legends-medic:client:ToggleDuty', function()
...
-- medic revive player
RegisterNetEvent('legends-medic:client:RevivePlayer', function()
    ...
    if hasItem then
        ...
        if player ~= -1 and distance < 5.0 then
            ...
            RSGCore.Functions.Progressbar("reviving", "Reviving...", Config.MedicReviveTime, false, true, {
                ...
                TriggerServerEvent('legends-medic:server:RevivePlayer', playerId)
...
-- medic treat wounds
RegisterNetEvent('legends-medic:client:TreatWounds', function()
    ...
    if hasItem then
        ...
        if player ~= -1 and distance < 5.0 then
            ...
            RSGCore.Functions.Progressbar("treating", "Treating Wounds...", Config.MedicTreatTime, false, true, {
                ...
                ClearPedTasks(PlayerPedId())
                TriggerServerEvent('legends-medic:server:TreatWounds', playerId)
                FreezeEntityPosition(PlayerPedId(), false)
                isHealingPerson = false
                transG = 0
            end)
...
-- medic treat wounds
RegisterNetEvent('legends-medic:client:HealInjuries', function()
...
-- medic alert
RegisterNetEvent('legends-medic:client:medicAlert', function(coords, text)
