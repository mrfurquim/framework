...
Citizen.CreateThread(function()
    for fasttravel, v in pairs(Config.FastTravelLocations) do
        exports['legends-core']:createPrompt(v.location, v.coords, RSGCore.Shared.Keybinds['J'], Lang:t('menu.open_prompt') .. v.name, {
            type = 'client',
            event = 'legends-fasttravel:client:menu',
            args = {},
        })
...
-- menu
RegisterNetEvent('legends-fasttravel:client:menu', function()
    ...
    exports['legends-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                isServer = true,
                event = 'legends-fasttravel:server:buyTicket',
                args = {
...
-- do fast travel
RegisterNetEvent('legends-fasttravel:client:doTravel')
AddEventHandler('legends-fasttravel:client:doTravel', function(travel)
