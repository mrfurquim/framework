    ...
    while true do
        ...
        if alcoholCount > 0 then
            ...
            elseif alcoholCount > Config.PassOut then
                TriggerEvent('legends-drinker:client:puke')
                Wait(10000)
                TriggerEvent('legends-drinker:client:cancelemote')
                TriggerEvent('legends-drinker:client:sleep')
                Wait(30000)
                TriggerEvent('legends-drinker:client:cancelemote')
...
RegisterNetEvent("legends-drinker:client:DrinkWhiskey")
AddEventHandler("legends-drinker:client:DrinkWhiskey", function()
...
RegisterNetEvent("legends-drinker:client:DrinkBeer")
AddEventHandler("legends-drinker:client:DrinkBeer", function()
...
RegisterNetEvent("legends-drinker:client:DrinkCoffee")
AddEventHandler("legends-drinker:client:DrinkCoffee", function()
...
RegisterNetEvent("legends-drinker:client:DrinkMoonshine")
AddEventHandler("legends-drinker:client:DrinkMoonshine", function()
...
RegisterNetEvent('legends-drinker:client:puke')
AddEventHandler('legends-drinker:client:puke', function()
...
RegisterNetEvent('legends-drinker:client:sleep')
AddEventHandler('legends-drinker:client:sleep', function()
...
RegisterNetEvent('legends-drinker:client:cancelemote')
AddEventHandler('legends-drinker:client:cancelemote', function()
