...
RegisterNetEvent('legends-looting:server:lootreward', function()
    local src = source
    ...
    if chance <= 95 then -- reward : 1 x common
        ...
        -- webhook
        TriggerEvent('legends-log:server:CreateLog', 'loot', 'looted 🌟', 'orange', firstname..' '..lastname..' found Loot baby!')
    ...
    elseif chance > 95 then -- reward : 1 x rare
        ...
        -- webhook
        TriggerEvent('legends-log:server:CreateLog', 'loot', 'looted citizen 🌟', 'orange', firstname..' '..lastname..' found Loot baby!')
    else
