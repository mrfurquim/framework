...
legends-target is a targeting solution that allows interaction with any predefined entity, model, entity type, or polyzone. While activated you can easily and safely replace markers and distance checking, instead relying on intuitive design to improve player experiences and optimize interaction.
...
* [RSGCore](https://github.com/Rexshack-RedM/legends-core)
...
This version is for RSGCore but can be used by any framework if you make your own changes to it.
