...
Citizen.CreateThread(function()
    for wholesale, v in pairs(Config.WholesaleLocations) do
        exports['legends-core']:createPrompt(v.prompt, v.coords, RSGCore.Shared.Keybinds['J'], 'Open ' .. v.name, {
            type = 'client',
            event = 'legends-wholesaletrader:client:openMenu',
            args = { v.job },
        })
...
RegisterNetEvent('legends-wholesaletrader:client:openMenu', function(job)
    ...
    if playerjob == job then
        ...
        exports['legends-menu']:openMenu({
            ...
            },
            {
                ...
                icon = "fas fa-box",
                params = {
                    event = 'legends-wholesaletrader:client:storage',
                    isServer = false,
                    args = {},
                }
            },
            {
                ...
                icon = "fas fa-box",
                params = {
                    event = 'legends-wholesaletrader:client:openShop',
                    isServer = false,
                    args = {},
                }
            },
            ...
            },
            {
                ...
                icon = "fas fa-horse",
                params = {
                    event = 'legends-jobwagon:client:openWagonMenu',
                    isServer = false,
                    args = {},
                }
            },
...
-- wholesale shop
RegisterNetEvent('legends-wholesaletrader:client:openShop')
AddEventHandler('legends-wholesaletrader:client:openShop', function()
...
RegisterNetEvent('legends-wholesaletrader:client:storage', function()
    local job = RSGCore.Functions.GetPlayerData().job.name
    if job == currentjob then
