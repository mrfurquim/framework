        ...
        exports['legends-target']:AddCircleZone(v.name, v.coords, 1, {
            ...
            debugPoly = false,
                ...
                options = {
                {
                    type = "client",
                    action = function()
                    TriggerEvent('legends-barber:client:menu', v.location)
                    end,
...
RegisterNetEvent("legends-barber:client:menu", function()
...
local MainMenus =
{
    ...
    ["save"] = function()
        ...
        TriggerServerEvent("legends-barber:server:SaveSkin", CreatorCache, male)
