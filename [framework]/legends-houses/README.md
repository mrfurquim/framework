# Asgard Scripts
- A slight modification of legends-houses with the following changes: 
```
...
- add legends-houses to your resources folder
- add the sql file "houses.sql" to your database

# NPC Setup
- add the following to your legends-npcs script
...
# Jobs Setup
- ensure the following Jobs have been setup legends-core/shared/jobs.lua
...
- add the following to your server.cfg file : ensure legends-houses
