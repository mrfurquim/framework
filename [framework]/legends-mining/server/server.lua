...
-- give mining reward
RegisterServerEvent('legends-mining:server:giveMiningReward')
AddEventHandler('legends-mining:server:giveMiningReward', function()
    local src = source
...
RegisterServerEvent('legends-mining:server:removeitem')
AddEventHandler('legends-mining:server:removeitem', function(item)
    local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
