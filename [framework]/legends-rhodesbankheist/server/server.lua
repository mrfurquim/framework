...
-- give reward
RegisterServerEvent('legends-rhodesbankheist:server:reward')
AddEventHandler('legends-rhodesbankheist:server:reward', function()
    local src = source
...
-- remove item
RegisterNetEvent('legends-rhodesbankheist:server:removeItem', function(item, amount)
	local src = source
    local Player = RSGCore.Functions.GetPlayer(src)
