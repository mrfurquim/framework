...
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('valentine-storage-1', vector3(-179.3819, 648.2138, 113.58127), RSGCore.Shared.Keybinds['J'], 'Open Valentine Storage', {
		type = 'client',
		event = 'legends-storage:client:valstorage',
...
RegisterNetEvent('legends-storage:client:valstorage', function()
...
-- blackwater --
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('blackwater-storage-1', vector3(-733.6947, -1253.501, 44.734077), RSGCore.Shared.Keybinds['J'], 'Open Blackwater Storage', {
		type = 'client',
		event = 'legends-storage:client:blkstorage',
		args = { false, true, false },
	})
...
RegisterNetEvent('legends-storage:client:blkstorage', function()
	RSGCore.Functions.GetPlayerData(function(PlayerData)
	local cid = PlayerData.citizenid
...
-- stdenis --
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('stdenis-storage-1', vector3(2669.6577, -1500.203, 45.968963), RSGCore.Shared.Keybinds['J'], 'Open StDenis Storage', {
		type = 'client',
		event = 'legends-storage:client:denstorage',
		args = { false, true, false },
	})
...
RegisterNetEvent('legends-storage:client:denstorage', function()
	RSGCore.Functions.GetPlayerData(function(PlayerData)
	local cid = PlayerData.citizenid
...
-- rhodes --
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('rhodes-storage-1', vector3(1231.0391, -1277.829, 76.021591), RSGCore.Shared.Keybinds['J'], 'Open Rhodes Storage', {
		type = 'client',
		event = 'legends-storage:client:rhostorage',
		args = { false, true, false },
	})
...
RegisterNetEvent('legends-storage:client:rhostorage', function()
	RSGCore.Functions.GetPlayerData(function(PlayerData)
	local cid = PlayerData.citizenid
...
-- annesburg --
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('annesburg-storage-1', vector3(2934.8232, 1306.6634, 44.47974), RSGCore.Shared.Keybinds['J'], 'Open Annesburg Storage', {
		type = 'client',
		event = 'legends-storage:client:annstorage',
		args = { false, true, false },
	})
...
RegisterNetEvent('legends-storage:client:annstorage', function()
	RSGCore.Functions.GetPlayerData(function(PlayerData)
	local cid = PlayerData.citizenid
...
-- strawberry --
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('strawberry-storage-1', vector3(-1752.021, -386.3956, 156.49397), RSGCore.Shared.Keybinds['J'], 'Open Strawberry Storage', {
		type = 'client',
		event = 'legends-storage:client:strstorage',
		args = { false, true, false },
	})
...
RegisterNetEvent('legends-storage:client:strstorage', function()
	RSGCore.Functions.GetPlayerData(function(PlayerData)
	local cid = PlayerData.citizenid
...
-- tumbleweed --
Citizen.CreateThread(function()
	exports['legends-core']:createPrompt('tumbleweed-storage-1', vector3(-5494.741, -2959.111, -0.69497), RSGCore.Shared.Keybinds['J'], 'Open Tumbleweed Storage', {
		type = 'client',
		event = 'legends-storage:client:tumstorage',
		args = { false, true, false },
	})
...
RegisterNetEvent('legends-storage:client:tumstorage', function()
	RSGCore.Functions.GetPlayerData(function(PlayerData)
	local cid = PlayerData.citizenid
